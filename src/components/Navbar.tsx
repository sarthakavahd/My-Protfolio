...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className={`relative border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] overflow-hidden group transition-all duration-300 ${open ? 'rounded-3xl bg-black/95 backdrop-blur-3xl' : 'rounded-full bg-black/40 backdrop-blur-md'}`}>
